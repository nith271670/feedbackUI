    ...
    this.httpService.getSurveyFeedbackList().subscribe(response => {
      ...
      for(var i=0; i < this.SurveyList.length; i++){
        ...
        this.SurveyListHeader[i]={
          ...
          "I think Elektrobit Indias' internal processes are geared towards providing the best possible solution to our external customers": this.SurveyList[i].surveydetails.passion.q6,
          ...
          "In my opinion we live our values (For One Another, Passion to Win, Freedom to Act, Trust) at Elektrobit India": this.SurveyList[i].surveydetails.leadership.q23,
