    ...
    this.httpService.getSurveyFeedbackList().subscribe(response => {
      ...
      for(var i=0; i < this.SurveyList.length; i++){
        ...
        this.SurveyListHeader[i]={
          ...
          "In my opinion Elektrobit India brings leading technology to the markets": this.SurveyList[i].surveydetails.passion.q5,
          "I think Elektrobit India's internal processes are geared towards providing the best possible solution to our external customers": this.SurveyList[i].surveydetails.passion.q6,
          "I think employees and leaders respect the Code of Conduct of Elektrobit India": this.SurveyList[i].surveydetails.passion.q7,
          "In my opinion I have sufficient opportunities to improve my skills through trainings at Elektrobit India": this.SurveyList[i].surveydetails.passion.q8,
          "I think I have the opportunity for personal development and growth within Elektrobit India": this.SurveyList[i].surveydetails.passion.q9,
          "I am satisfied with my involvement in decisions that affect my work": this.SurveyList[i].surveydetails.freedom.q10,
          "I understand how my work contributes to Elektrobit India's business objectives": this.SurveyList[i].surveydetails.freedom.q11,
          ...
          "We celebrate our successes at Elektrobit India": this.SurveyList[i].surveydetails.foroneanother.q14,
          "I think leaders at Elektrobit India support diversity (e.g. diverse perspectives, gender, different cultures etc.) in the workplace (by recognizing and respecting the value of human differences.)": this.SurveyList[i].surveydetails.foroneanother.q15,
          ...
          "I think leaders at Elektrobit India offer equal opportunities for all employees": this.SurveyList[i].surveydetails.foroneanother.q18,
          ...
          "In my opinion the leadership style at Elektrobit India encourages employees to give their best": this.SurveyList[i].surveydetails.leadership.q22,
          "In my opinion we live our values (For One Another, Passion to Win, Freedom to Act, Trust, Excellence with agility) at Elektrobit India": this.SurveyList[i].surveydetails.leadership.q23,
          "I think we are doing a good job of retaining people at Elektrobit India": this.SurveyList[i].surveydetails.leadership.q24,
          "In my opinion Elektrobit India pays me fairly for the work I do (fixed pay, bonus/incentive, benefits)": this.SurveyList[i].surveydetails.performance.q25,
          ...
          "In my opinion Elektrobit India recognizes and rewards good performance not just with money": this.SurveyList[i].surveydetails.performance.q30,
          "In my opinion I am able to balance my work-life and my private-life (e.g. via a flexible work schedule) at Elektrobit India": this.SurveyList[i].surveydetails.w_conditions.q31,
          "I think at Elektrobit India the health and safety of its employees is cared for": this.SurveyList[i].surveydetails.w_conditions.q32,
          "Always I feel enthusiastic to come to work every day ": this.SurveyList[i].surveydetails.w_conditions.q33,
          "I think at Elektrobit India priority is given to safety even if there was a conflict between safety and other business objectives": this.SurveyList[i].surveydetails.w_conditions.q34,
          ...
          "I think leaders in Elektrobit India are interested in the well-being of employees": this.SurveyList[i].surveydetails.w_conditions.q36,
          "I have enough energy to deliver my work well": this.SurveyList[i].surveydetails.s_engagement.q37,
          "I am proud to work for Elektrobit India": this.SurveyList[i].surveydetails.s_engagement.q38,
          ...
          "I fully support the values (Freedom to Act, Passion to Win, For One Another, Trust, Excellence with Agility ) for which Elektrobit India stands": this.SurveyList[i].surveydetails.s_engagement.q40,
          ...
          "In my opinion at Elektrobit India, an excellent job is done in standardizing processes to ensure consistent quality": this.SurveyList[i].surveydetails.strategy_quality.q45,
          "I have confidence in the decisions made by the top management team of Elektrobit India": this.SurveyList[i].surveydetails.strategy_quality.q46,
          "I think Elektrobit India's commitment to quality is apparent in what we do on a daily basis": this.SurveyList[i].surveydetails.strategy_quality.q47,
          ...
          "I think I have a good understanding of Elektrobit India's strategy": this.SurveyList[i].surveydetails.strategy_quality.q49,
